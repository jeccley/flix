...
movie.reviews.create!([
                        {
                          name: "Curly", stars: 4,
                          comment: "What is not to like about this movie?"
                        },
                        {
                          name: "Larry", stars: 5,
                          comment: "Fave movie of all time!"
                        },
                        {
                          name: "Moe", stars: 2,
                          comment: "Robert Downey Jr just annoys me in this film"
                        }
                      ])

# This seed is to setup a cult class test case
...
movie.reviews.create!([
                        ...
                        {
                          name: "Moe", stars: 4,
                          comment: "Super costumes and acting"
                        },
                        {
                          name: "Curly", stars: 4,
                          comment: "What is not to like about this movie?"
...
User.create!(name: "Jon", username: "jeccles", email: "jon@example.com",
             password: "secret1010", password_confirmation: "secret1010",
             admin: true)

User.create!(name: "James", username: "jammy", email: "james@example.com",
             password: "secret1010", password_confirmation: "secret1010")

User.create!(name: "Catherine", username: "cath", email: "catherine@example.com",
             password: "secret1010", password_confirmation: "secret1010")
...
Genre.create(name: "Black Comedy")
